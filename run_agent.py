...
_loaded_env_paths = load_claudia_dotenv(claudia_home=_claudia_home, project_env=_project_env)
...
class _SafeWriter:
    ...
    When claudia-autonomous runs as a systemd service, Docker container, or headless
...
class AIAgent:
    ...
    def __init__(
        ...
        # Claudia is a tool-using client by default.
        ...
        # Persistent error log -- always writes WARNING+ to ~/.claudia/logs/errors.log
        ...
        error_log_dir = _claudia_home / "logs"
                ...
                if _routed_client is not None:
                    ...
                    if _explicit and _explicit not in ("auto", "openrouter", "custom"):
                        raise RuntimeError(
                            ...
                            f"variable, or switch to a different provider with `claudia model`."
                        )
        ...
        # Session logs go into ~/.claudia/sessions/ alongside gateway sessions
        claudia_home = get_claudia_home()
        self.logs_dir = claudia_home / "sessions"
        ...
        if self._session_db:
            try:
                self._session_db.create_session(
                    ...
                    source=self.platform or os.environ.get("CLAUDIA_SESSION_SOURCE", "cli"),
                    model=self.model,
                    model_config={
            ...
            try:
                ...
                if _mem_provider_name:
                    ...
                    if self._memory_manager.providers:
                        from claudia_constants import get_claudia_home as _ghh
                        _init_kwargs = {
                            "session_id": self.session_id,
                            "platform": platform or "cli",
                            "claudia_home": str(_ghh()),
                        ...
                        try:
                            ...
                            _init_kwargs["agent_workspace"] = "claudia"
                        except Exception:
                            pass
    ...
    def _dump_api_request_debug(
        ...
        *,
        ...
        try:
            ...
            if env_var_enabled("CLAUDIA_DUMP_REQUEST_STDOUT"):
    ...
    def _build_system_prompt(self, system_message: str = None) -> str:
        ...
        if not self.skip_context_files:
            ...
            # mode).  The gateway process runs from the claudia-autonomous install
        ...
        from claudia_time import now as _claudia_now
        now = _claudia_now()
    ...
    def _try_refresh_nous_client_credentials(self, *, force: bool = True) -> bool:
        ...
        try:
            ...
            creds = resolve_nous_runtime_credentials(
                min_key_ttl_seconds=max(60, int(os.getenv("CLAUDIA_NOUS_MIN_KEY_TTL_SECONDS", "1800"))),
                timeout_seconds=float(os.getenv("CLAUDIA_NOUS_TIMEOUT_SECONDS", "15")),
                force_mint=force,
            )
        except Exception as exc:
    ...
    def _interruptible_streaming_api_call(
        ...
        def _call_chat_completions():
            ...
            import httpx as _httpx
            _base_timeout = float(os.getenv("CLAUDIA_API_TIMEOUT", 1800.0))
            _stream_read_timeout = float(os.getenv("CLAUDIA_STREAM_READ_TIMEOUT", 60.0))
            stream_kwargs = {
                **api_kwargs,
                "stream": True,
        ...
        def _call():
            ...
            _max_stream_retries = int(os.getenv("CLAUDIA_STREAM_RETRIES", 2))
        ...
        _stream_stale_timeout_base = float(os.getenv("CLAUDIA_STREAM_STALE_TIMEOUT", 180.0))
    ...
    def _build_api_kwargs(self, api_messages: list) -> dict:
        ...
        api_kwargs = {
            ...
            "timeout": float(os.getenv("CLAUDIA_API_TIMEOUT", 1800.0)),
        }
        if self.tools:
        ...
        if _is_nous:
            extra_body["tags"] = ["product=claudia-autonomous"]
    ...
    def _handle_max_iterations(self, messages: list, api_call_count: int) -> str:
        ...
        try:
            ...
            if _is_nous:
                summary_extra_body["tags"] = ["product=claudia-autonomous"]
        ...
        while api_call_count < self.max_iterations and self.iteration_budget.remaining > 0:
            ...
            while retry_count < max_retries:
                try:
                    ...
                    if env_var_enabled("CLAUDIA_DUMP_REQUESTS"):
                    ...
                    if (
                        ...
                        _dhh = _dhh_fn()
                        print(f"{self.log_prefix}     • Check ANTHROPIC_TOKEN in {_dhh}/.env for Claudia-managed OAuth/setup tokens")
                        print(f"{self.log_prefix}     • Check ANTHROPIC_API_KEY in {_dhh}/.env for API keys or legacy token values")
                        print(f"{self.log_prefix}     • For API keys: verify at https://console.anthropic.com/settings/keys")
                        print(f"{self.log_prefix}     • For Claude Code: run 'claude /login' to refresh, then retry")
                        print(f"{self.log_prefix}     • Clear stale keys: claudia config set ANTHROPIC_TOKEN \"\"")
                        print(f"{self.log_prefix}     • Legacy cleanup: claudia config set ANTHROPIC_API_KEY \"\"")
                    ...
                    if is_client_error:
                        ...
                        if status_code in (401, 403) or "unauthorized" in error_msg or "forbidden" in error_msg or "permission" in error_msg:
                            ...
                            self._vprint(f"{self.log_prefix}      • Is the key valid? Run: claudia setup", force=True)
                        ...
                        if self._empty_content_retries < 3:
                            ...
                            if empty_response_info["is_local_custom"]:
                                error_message = (
                                    ...
                                    "Likely causes: wrong /v1 endpoint, runtime context window smaller than Claudia expects, "
