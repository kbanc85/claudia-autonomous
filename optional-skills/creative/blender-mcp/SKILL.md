---
name: blender-mcp
description: Control Blender directly from Claudia via socket connection to the blender-mcp addon. Create 3D objects, materials, animations, and run arbitrary Blender Python (bpy) code. Use when user wants to create or modify anything in Blender.
version: 1.0.0
...
Control a running Blender instance from Claudia via socket on TCP port 9876.
