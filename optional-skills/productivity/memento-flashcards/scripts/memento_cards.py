...
Data file: $CLAUDIA_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_CLAUDIA_HOME = Path(os.environ.get("CLAUDIA_HOME", Path.home() / ".claudia"))
DATA_DIR = _CLAUDIA_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
