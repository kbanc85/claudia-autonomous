...
4. Name the token (e.g., "Claudia"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.claudia/.env`:
...
```bash
CANVAS="python $CLAUDIA_HOME/skills/productivity/canvas/scripts/canvas_api.py"
