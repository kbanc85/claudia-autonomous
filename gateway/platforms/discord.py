...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def _register_slash_commands(self) -> None:
        ...
        @tree.command(name="reset", description="Reset your Claudia session")
        ...
        @tree.command(name="status", description="Show Claudia session status")
        ...
        @tree.command(name="stop", description="Stop the running Claudia")
        ...
        @tree.command(name="update", description="Update Claudia to the latest version")
        ...
        @tree.command(name="thread", description="Create a new thread and start a Claudia session in it")
        @discord.app_commands.describe(
            name="Thread name",
            message="Optional first message to send to Claudia in the thread",
    ...
    async def _handle_thread_create_slash(
        ...
        # If a message was provided, kick off a new Claudia session in the thread
    ...
    async def _create_thread(
        ...
        *,
        ...
        try:
            ...
            try:
                seed_content = starter_message or f"\U0001f9f5 Thread created by Claudia: **{name}**"
    ...
    async def _auto_create_thread(self, message: 'DiscordMessage') -> Optional[Any]:
        ...
        thread_name = content[:80] if content else "Claudia"
        if len(content) > 80:
