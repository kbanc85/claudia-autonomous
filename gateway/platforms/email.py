"""
Email platform adapter for the Claudia gateway.

Allows users to interact with Claudia by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "Claudia")
        ...
        msg_id = f"<claudia-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
