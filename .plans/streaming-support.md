# Streaming LLM Response Support for Claudia
...
```
CLAUDIA_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("CLAUDIA_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `claudia_cli/config.py` | 1 | +streaming config defaults |
...
CLAUDIA_STREAMING_ENABLED=true
```
