...
class TestWriteDenyExactPaths:
    ...
    def test_claudia_env(self):
        path = os.path.join(str(Path.home()), ".claudia", ".env")
        assert _is_write_denied(path) is True
...
class TestWriteAllowed:
    ...
    def test_claudia_config_not_env(self):
        path = os.path.join(str(Path.home()), ".claudia", "config.yaml")
