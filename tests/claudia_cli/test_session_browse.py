"""Tests for the interactive session browser (`claudia sessions browse`).
...
from claudia_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """claudia sessions browse should be parseable."""
        from claudia_cli.main import main as _main_entry
