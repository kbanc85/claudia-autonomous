...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("claudia_cli.config.get_config_path", return_value=config_path), \
             patch("claudia_cli.config.ensure_hermes_home"):
    ...
    def test_ensure_hermes_home_sets_0700(self):
        ...
        with patch("claudia_cli.config.get_hermes_home", return_value=home):
            from claudia_cli.config import ensure_hermes_home
            ensure_hermes_home()
