"""
Cron job scheduling system for Claudia.
...
Cron jobs are executed automatically by the gateway daemon:
    claudia gateway install    # Install as a user service
    sudo claudia gateway install --system  # Linux servers: boot-time system service
    claudia gateway            # Or run in foreground
