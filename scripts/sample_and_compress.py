...
DEFAULT_DATASETS = [
    "kbanc85/swe-terminus-agent-glm-kimi-minimax",
    "kbanc85/claudia-autonomous-megascience-sft1",
    "kbanc85/Claudia-Agent-Thinking-GLM-4.7-SFT2",
    "kbanc85/Claudia-Agent-Thinking-GLM-4.7-SFT1",
    "kbanc85/terminal-tasks-glm-claudia-autonomous"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "kbanc85/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload kbanc85/{output_name} {final_output}")
