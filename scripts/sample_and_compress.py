...
DEFAULT_DATASETS = [
    ...
    "NousResearch/claudia-autonomous-megascience-sft1",
    "NousResearch/Claudia-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Claudia-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-claudia-autonomous"
]
