...
version: 1.1.0
author: Claudia (adapted from obra/superpowers)
license: MIT
metadata:
  claudia:
...
> **For Claudia:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use Claudia tools to understand the project:
