...
```bash
python3 -m pyfiglet "CLAUDIA" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=CLAUDIA&font=Slant" | boxes -d stone
```
