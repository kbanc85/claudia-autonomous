#!/usr/bin/env python3
"""Google Workspace OAuth2 setup for Claudia.
...
def store_client_secret(path: str):
    """Copy and validate client_secret.json to Claudia home."""
...
def main():
    parser = argparse.ArgumentParser(description="Google Workspace OAuth setup for Claudia")
