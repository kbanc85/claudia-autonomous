...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - claudia_home (str): The active CLAUDIA_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.claudia``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "claudia").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'claudia memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], claudia_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'claudia memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``claudia_home`` is the active CLAUDIA_HOME directory path.
