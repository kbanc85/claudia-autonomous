...
Usage:
    claudia pairing list              # Show all pending + approved users
    claudia pairing approve <platform> <code>  # Approve a pairing code
    claudia pairing revoke <platform> <user_id> # Revoke user access
    claudia pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle claudia pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: claudia pairing {list|approve|revoke|clear-pending}")
        print("Run 'claudia pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'claudia pairing list' to see pending codes.\n")
