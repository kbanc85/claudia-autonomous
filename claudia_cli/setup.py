...
def _setup_copilot_reasoning_selection(
    ...
    *,
    ...
    from claudia_cli.models import github_model_reasoning_efforts, normalize_copilot_model_id
...
def _get_section_config_summary(config: dict, section_key: str) -> Optional[str]:
    ...
    ``get_env_value`` is the module-level import from claudia_cli.config
