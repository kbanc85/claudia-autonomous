...
def _socket_safe_tmpdir() -> str:
    ...
    append ``agent-browser-claudia_…`` the resulting socket path exceeds the
...
def _find_agent_browser() -> str:
    ...
    if os.path.isdir(claudia_node_bin):
        extra_dirs.append(claudia_node_bin)
...
def _maybe_start_recording(task_id: str):
    ...
    try:
        ...
        recordings_dir = claudia_home / "browser_recordings"
...
def browser_vision(question: str, annotate: bool = False, task_id: Optional[str] = None) -> str:
    ...
    screenshots_dir = get_claudia_dir("cache/screenshots", "browser_screenshots")
