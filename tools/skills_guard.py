...
Trust levels:
  - builtin:   Ships with Claudia. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.claudia/\.env|\~/\.claudia/\.env',
     "claudia_env_access", "critical", "exfiltration",
     "directly references Claudia secrets file"),
    ...
    (r'\.claudia/config\.yaml|\.claudia/SOUL\.md',
     "claudia_config_mod", "critical", "persistence",
     "references Claudia configuration files directly"),
...
def _get_configured_model() -> str:
    """Load the user's configured model from ~/.claudia/config.yaml."""
    try:
