...
~/.claudia/skills/. Existing skills (bundled, hub-installed, or user-created)
...
# All skills live in ~/.claudia/skills/ (single source of truth)
...
def _find_skill(name: str) -> Optional[Dict[str, Any]]:
    """
    Find a skill by name in ~/.claudia/skills/.
...
SKILL_MANAGE_SCHEMA = {
    ...
    "description": (
        ...
        "New skills go to ~/.claudia/skills/; existing skills can be modified wherever they live.\n\n"
