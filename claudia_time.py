"""
Timezone-aware clock for Claudia.
...
Invalid timezone values log a warning and fall back safely — Claudia never
...
try:
    ...
    # Python 3.8 fallback (shouldn't be needed — Claudia requires 3.9+)
