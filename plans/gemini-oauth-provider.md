...
## Client ID
- Need to register a "Desktop app" OAuth client on a Kamil Banc GCP project
...
## Token Lifecycle
- Store at `~/.claudia/gemini_oauth.json` (NOT sharing with `~/.gemini/oauth_creds.json`)
...
## Prerequisites
- Kamil Banc GCP project with Desktop OAuth client registered
- OR: accept user-provided client_id via CLAUDIA_GEMINI_CLIENT_ID env var
